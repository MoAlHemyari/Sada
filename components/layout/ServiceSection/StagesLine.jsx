  ...
  return (
    <div ref={ref} className="w-full max-w-6xl mx-auto px-4 py-8">
      <div className="relative">
        ...
        <div
          className={`relative flex flex-col tablet:grid tablet:grid-cols-6 gap-7 tablet:gap-2 [&>*] ${isRTL ? "tablet:flex-row-reverse" : ""
            }`}
        >
          {Object.values(dict).map((stage, index) => (
            ...
            >
              <div className="relative w-16 tablet:w-full flex justify-center">
                ...
                <div
                  id="mobile-line"
                  className={`absolute tablet:hidden -top-6 bottom-0 ${isRTL ? "right-[100px]" : "left-[92px]"
              ...
              <div
                className={`flex-grow w-max tablet:flex-grow-0 ${isRTL ? "mr-16 tablet:mr-0" : "ml-14 tablet:ml-0"
                  }`}
              >
